...
namespace doann.presenation
{
    class menu
    {
        ...
        public static void HienMN()
        {
            ...
            mn[0] = new string[] { "1.Nhan vien", "A.Nhập nhân viên", "B.Sửa nhân viên", "C.Xóa nhân viên", "D.Tim kiem" };

            mn[1] = new string[] { "2.Hàng hóa", "E.Nhập hàng hóa", "G.Sửa hàng hóa", "H.Xóa hàng hóa", "I.Hien thi", "K.Tim kiem" };

            mn[2] = new string[] { "3.Nhà cung cấp ", "N.Nhập nhà cung cấp", "M.Sửa nhà cung cấp", "P.Xóa nhà cung cấp", "Q.Tim kiem" };

            mn[3] = new string[] { "4.Gia bán ", "V.Nhập giá bán", "S.Sửa giá bán", "R.Xóa giá bán", "T.Hiển thị", "O.Hien Thi Tim kiem", "U.timkiem" };

            mn[4] = new string[] { "5.Hóa đơn bán ", "Z.Nhập hóa đơn bán", "Ư.Sửa hóa đơn bán", "@.Xóa hóa đơn bán", "#.Tim kiem"};

            mn[5] = new string[] { "6.Hoa don nhap ", "$.Nhập hóa đơn nhập", "%.Sửa hóa đơn nhập", "&.Xóa hóa đơn nhập", "*.Tim kiem" };

            mn[6] = new string[] { "7.Tính lương ", "Đ.Nhập tính lương", "W.Sửa bảng lương", "J.Xóa bảng lương", "0.Tim kiem" };
