...
namespace doann.DataAccessLayer
{
    class nhanvienDAL: InhanvienDAL
    {
        ...
        //lay du lieu tu nhân viên dua vao danh sach0
        ...
        {
            string manv = "nv"+ DateTime.Now.ToString("ss");
            StreamWriter fwrite = File.AppendText(txtfile);
            fwrite.WriteLine();
            fwrite.Write(manv + "#"+nv.Tennv +"#"+ nv.Gioitinh + "#" + nv.Loainv+"#"+nv.Ngaysinh+"#"+nv.Ngayvaolv);
            fwrite.Close();
        }
        //Cập nhật lại danh sách vào tệp        đây để tôi xem ddoanjj này
