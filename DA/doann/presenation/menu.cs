...
namespace doann.presenation
{
    class menu
    {
        ...
        public static void HienMN()
        {
            ...
            mn[0] = new string[] { "1.Nhân viên", "A.Nhập nhân viên", "B.Sửa nhân viên", "C.Xóa nhân viên","D.Hiển thị", "^.Tim kiem" };
            ...
            mn[3] = new string[] { "4.Gia bán ", "V.Nhập giá bán", "S.Sửa giá bán", "R.Xóa giá bán", "T.Hiển thị", "U.Tìm kiếm" };
            ...
            mn[6] = new string[] { "7.Tính lương ", "<.Nhập tính lương", "W.Sửa bảng lương", "J.Xóa bảng lương","+.Hiển thị" ,">.Tìm kiếm" };
